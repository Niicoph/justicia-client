  ...
  return (
    <Wrapper>
      <div className="flex flex-col items-center w-full min-h-screen">
        <Header />
        <main className="flex flex-col items-center w-full h-full gap-20">
          <AnimatedContent
            distance={150}
            direction="vertical"
            reverse={false}
          ...
          >
            {/* Hero section */}
            <section className="bg-hero flex flex-col items-center overflow-hidden ">
              <div className="flex flex-col gap-16 w-full h-fit justify-center items-center nunito-extrabold text-white text-center pt-6 pb-6 z-20">
                <div className="flex flex-col justify-center items-center">
                  <BlurText
                    text="Todo tu despacho en un unico lugar"
                    delay={150}
                    animateBy="words"
                    direction="top"
          ...
          <section className="flex flex-col items-center w-full gap-5 text-white">
            <div className="flex flex-col gap-5 w-full text-left">
              <h2 className="text-main-h2 nunito-extrabold text-white">
                ¿Qué es justic.ia?
              </h2>
          ...
          {/* Features section */}
          <section className="relative flex flex-col items-center w-full gap-5 text-white ">
            <div className="flex flex-col gap-5 w-full text-left">
              <h2 className="text-main-h2 nunito-extrabold text-white">
          ...
          <section className="flex flex-col items-center w-full gap-5 text-white">
            <div className="flex flex-col gap-5 w-full text-left">
              <h2 className="text-main-h2 nunito-extrabold text-white">FAQ</h2>
            </div>
